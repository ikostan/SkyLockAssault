...
| https://github.com/ikostan/SkyLockAssault/issues/495 | Add a GUT test suite in res://test/unit/test_nav_escape_sfx.gd targeting Globals (globals.gd) that verifies global navigation and ui_cancel behavior, including menu-context gating, echo mitigation, focus gates for LineEdit/Slider, single-dispatch guarantee, and suppression for unrelated actions. | ✅         |             |
| https://github.com/ikostan/SkyLockAssault/issues/495 | Add a GUT test suite in res://test/unit/test_quit_game_confirm_dialog_sfx.gd targeting MainMenu (main_menu.gd) that verifies quit dialog confirmation and cancellation audio routing via AudioManager and ensures flat menu buttons do not trigger global ui_accept confirmation SFX.                    | ✅         |             |
