...
| Disable Godot export cache in the itch.io deployment workflow to force fresh recompilation on each run. | <ul><li>Set the Godot export action cache option from enabled to disabled so exports do not reuse previous build artifacts</li><li>Ensure web preset exports always rebuild freshly injected GDScript instead of relying on GitHub Actions cache</li></ul>                                                                                                                                                                                                                                                                                                               | `.github/workflows/deploy_to_itch.yml`                                                                                                                                                                                 |
...
| **#608** | Modify the GitHub Actions workflow `.github/workflows/deploy_to_itch.yml` so that the `firebelley/godot-export` step runs with export caching disabled, ensuring Godot recompiles the GDScript with the injected production salt instead of using stale cached bytecode. | ✅         |                                                                                                                                                                                      |
