...
##
## Prints a timestamped and level-tagged message to the console if the given level meets or
## exceeds the current settings threshold.
##
...
## Returns the version string configured in project settings.
...
## Sets the project configuration version for testing purposes.
##
...
## and falling back to legacy plaintext formats if necessary.
##
## [param path]: The path parameter.
## Returns Returns a Dictionary containing keys config, err, and is_legacy.
