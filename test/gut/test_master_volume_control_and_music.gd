...
func test_tc_music_02() -> void:
	audio_instance._on_music_mute_toggled(false)  # Simulate toggle to muted
	audio_instance.mute_music.button_pressed = false  # Update button
...
func test_tc_music_03() -> void:
	...
	audio_instance.mute_music.button_pressed = true  # Update button
...
func test_tc_music_06() -> void:
	...
	assert_true(audio_instance.master_warning_dialog.visible)  # Dialog popped
	assert_false(AudioManager.music_muted)  # No unmute
...
func test_tc_music_09() -> void:
	...
	# Assert master_warning_dialog.popup_centered called
	# Assert event consumed
	assert_true(AudioManager.music_muted)  # No toggle, still muted
...
func test_tc_music_14() -> void:
	...
	assert_almost_eq(audio_instance.music_slider.value, db_to_linear(AudioServer.get_bus_volume_db(AudioServer.get_bus_index("Music"))), 0.0001)  # No change
	assert_true(AudioManager.music_muted)  # No unmute
